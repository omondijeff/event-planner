...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ to: ("/login"), ...{ class: ("font-medium text-primary hover:text-primary-dark") }, }));
    const __VLS_2 = __VLS_1({ to: ("/login"), ...{ class: ("font-medium text-primary hover:text-primary-dark") }, }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.input)({ id: ("email"), name: ("email"), type: ("email"), required: (true), ...{ class: ("mt-1 block w-full px-3 py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm") }, });
    (__VLS_ctx.email);
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.input)({ id: ("password"), name: ("password"), type: ("password"), required: (true), ...{ class: ("mt-1 block w-full px-3 py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm") }, });
    (__VLS_ctx.password);
